...
# Switches (used for controlling inputs, like image_select, etc.)
...
# Image Select Switch (if used, map to a switch or button)
set_property PACKAGE_PIN V14 [get_ports {image_select[0]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {image_select[0]}]
set_property PACKAGE_PIN W14 [get_ports {image_select[1]}]					
